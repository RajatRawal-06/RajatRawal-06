...
# ===========================================================================
HOST = "rajat"   # shown as  rajat@github  in the header
...
ROWS = [
    ...
    ("kv", "AI / ML", "PyTorch, TensorFlow, LangChain, RAG"),
    ("kv", "Frontend", "React, Next.js, Three.js"),
    ("kv", "Backend", "Flask, FastAPI, Supabase, Redis"),
    ("kv", "Tools", "Docker, Git, Chrome Extensions"),
    ("gap",),
    ("sec", "Highlights"),
